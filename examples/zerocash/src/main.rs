//! ZeroCash Pour circuit example
//!
//! This sample circuit is an identical replica of the ZeroCash Pour circuit, as described in
...
fn main() {
    println!("{}", format!("Fumbo").blue());
    println!("ZeroCash Pour circuit example");
    println!("-----------------------------");
}